...
if ($action === "courseDrops") {
    ...
    header(
        "Location: /cms/view/admin/course-drop-approval.php"
    );
...
if ($action === "approveCourseDrop") {
    ...
    header(
        "Location: /cms/controller/CourseDropController.php?action=courseDrops"
    );
